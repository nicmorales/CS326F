# Generated by Django 2.0.2 on 2018-04-07 23:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dndev.CharacterClass')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dndev.CharacterClass')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_level', models.SmallIntegerField(default=0, help_text='Enter the required level for this spell', null=True)),
                ('ranking', models.SmallIntegerField(default=0, help_text='Enter the ranking of this spell relative to the other spells available for this class.', null=True)),
                ('subclass', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dndev.CharacterSubclass')),
            ],
        ),
        migrations.CreateModel(
            name='Equipment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(default='', help_text='Enter a description of this feature; i.e. what this feature does', max_length=5000)),
                ('required_level', models.SmallIntegerField(default=0, help_text='Enter the required level for this feature', null=True)),
                ('race', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dndev.Race')),
            ],
        ),
        migrations.CreateModel(
            name='Spells',
            fields=[
                ...
                ('area_effected', models.CharField(default='', help_text='Enter the area affected by the spell after it connects (in feet).', max_length=10000)),
                ('required_materials', models.CharField(default='', help_text='Enter the required materials to cast this spell in JSON format.', max_length=10000)),
                ('component_1', models.CharField(default='', help_text='Enter the spell components to cast this spell', max_length=10000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_race', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dndev.Race')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('required_level', models.SmallIntegerField(default=0, help_text='Enter the required level for this feature', null=True)),
                ('sub_feature_name', models.CharField(default='', help_text='Enter the name of this feature', max_length=100, primary_key=True, serialize=False)),
                ('name', models.CharField(default='', help_text='Enter the name of the subrace', max_length=100, primary_key=True)),
                ('description', models.CharField(default='', help_text='Enter a description for these features', max_length=5000)),
                ('subrace', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dndev.Subrace')),
            ],
        ),
        migrations.CreateModel(
            name='Weapon',
